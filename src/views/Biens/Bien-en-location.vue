      ...
      <div v-if="biens == ''">
        ...
        <div v-else class="col mb-5" v-for="bien in biens" :key="bien.idBien">
          <div class="card h-100">
            <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">En location</div>
            <!-- Product image-->
            ...
            <div class="card-body p-4">
              <div class="text-center">
                <!-- Product name-->
                <h5 class="fw-bolder">{{bien.descriptionBien.slice(0,35)}}[...]</h5>
                <!-- Product price-->
                {{ bien.prixBien }} FCFA /Jours
              </div>
            </div>
            <!-- Product actions-->
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
              <router-link :to="'/bien/details/' + bien.idBien">
                <div class="text-center">
                  ...
                  <a class="btn btn-outline-dark mt-auto">Voir details <i class="bi bi-eye"></i></a>
                </div>
              </router-link>
            </div>
          </div>
...
export default {
  ...
  methods: {
    retrieveBiens() {
      BienDataService.getBiensLocation()
        .then((response) => {
